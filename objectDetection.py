...
with open('OpenCVdnn\object_detection_classes_coco.txt', 'r') as f:
...
# Load the DNN model
#model = cv2.dnn.readNet(model='OpenCVdnn/frozen_inference_graph.pb', config='OpenCVdnn/ssd_mobilenet_v2_coco_2018_03_29.pbtxt.txt', framework='TensorFlow')
model = cv2.dnn.readNet(model='C:/Users/jpedr/Documents/Python/OpenCVdnn/frozen_inference_graph.pb', config='C:/Users/jpedr/Documents/Python/OpenCVdnn/ssd_mobilenet_v2_coco_2018_03_29.pbtxt.txt', framework='TensorFlow')
